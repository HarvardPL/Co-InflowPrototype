...
//        public boolean get() {return (this.x);}
        public Labeled<Boolean> get() {return x0;}
      }
      public static boolean foo(boolean h) {
    	  	Labeled<Boolean> input = CoInFlowUserAPI.toLabeled(h, CoInFlowUserAPI.getLattice().getLabelByName("high"));
        A a1 = new A(input);
        Labeled<Boolean> input_l = CoInFlowUserAPI.toLabeled(true, CoInFlowUserAPI.getLattice().getLabelByName("low"));
        A a2 = new A(input_l);
