...
### IFSpec_harness 
This provides a program, _IFSpecCompilation.java_, that automatically compiles the IFSpec benchmark suites into Co-Inflow versions. 
